# -*- coding: utf-8 -*-
"""中科大2025招生宣传PPT — WPS COM automation."""
import os, json, pythoncom, win32com.client

OUT = r"D:\A-资料\A-claudewenjian\PPT制作\中国科学技术大学\work"
...
def run():
    ...
    def draw_card_list_wide(s, e):
        ...
        cols = ['#003B6F','#C41230','#1A6DB5','#007A6E','#C8922A','#E0682A','#003B6F','#C41230','#1A6DB5','#007A6E']
    ...
    pptx_path = os.path.join(OUT, "中科大2025本科招生宣传.pptx")
    ppt.SaveAs(pptx_path)
    print(f"PPTX: {pptx_path} ({os.path.getsize(pptx_path):,} bytes)")
    pdf_path = os.path.join(OUT, "中科大2025本科招生宣传.pdf")
    try:
