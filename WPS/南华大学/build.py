# -*- coding: utf-8 -*-
"""南华大学2025招生PPT — WPS COM automation."""
import os, json, pythoncom, win32com.client

OUT = r"D:\A-资料\A-claudewenjian\PPT制作\南华大学\work"
...
def run():
    ...
    def draw_table(s, e):
        ...
        dta = e['data']
        hdr = hex2bgr(e.get('header_color','#004C97'))
    ...
    def draw_card_list_wide(s, e):
        ...
        cols = ['#004C97','#007A33','#E06020','#C41230','#C8922A','#007A6E','#5C2D82','#004C97','#007A33','#E06020']
    ...
    def draw_tagline_bar(s, e):
        col = hex2bgr(e.get('color','#004C97'))
        x,y,w,h = e['x'],e['y'],e['w'],e['h']
        rrect(s, x, y, w, h, col)
    ...
    pptx_path = os.path.join(OUT, "南华大学2025本科招生-核特班卓越医师班.pptx")
    ppt.SaveAs(pptx_path)
    print(f"PPTX: {pptx_path} ({os.path.getsize(pptx_path):,} bytes)")
    pdf_path = os.path.join(OUT, "南华大学2025本科招生-核特班卓越医师班.pdf")
    try:
