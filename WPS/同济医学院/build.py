# -*- coding: utf-8 -*-
"""华科同济医学院 PPT - WPS COM automation."""
import os, json, pythoncom, win32com.client

OUT = r"D:\A-资料\A-claudewenjian\PPT制作\同济医学院\work"
JSON_PATH = os.path.join(OUT, "hust_data.json")
...
def run():
    ...
    def draw_card_list_wide(s, e):
        ...
        cols = ['#C41230','#004098','#C8922A','#007A6E','#E0682A','#6B2D5C','#C41230','#004098','#C8922A','#007A6E']
    ...
    pptx_path = os.path.join(OUT, "华科同济医学院前世今生.pptx")
    ppt.SaveAs(pptx_path)
    print(f"PPTX: {pptx_path} ({os.path.getsize(pptx_path):,} bytes)")
    pdf_path = os.path.join(OUT, "华科同济医学院前世今生.pdf")
    try:
