# -*- coding: utf-8 -*-
"""中山大学2025招生PPT — WPS COM automation."""
import os, json, pythoncom, win32com.client

OUT = r"D:\A-资料\A-claudewenjian\PPT制作\中山大学\work"
...
def run():
    ...
    pptx_path = os.path.join(OUT, "中山大学2025本科招生数据全景.pptx")
    ppt.SaveAs(pptx_path)
    print(f"PPTX: {pptx_path} ({os.path.getsize(pptx_path):,} bytes)")
    pdf_path = os.path.join(OUT, "中山大学2025本科招生数据全景.pdf")
    try:
